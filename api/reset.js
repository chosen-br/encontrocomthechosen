...
export default async function handler(req, res) {
  try {
    ...
    const keys = ['cad:total', 'cad:byday', 'acc:total', 'acc:byday', 'dl:total', 'dl:byres', 'dl:byday', 'relato:total', 'relato:ultimo', 'rel:byday', 't6:play', 't6:share', 't6:dl', 'popup:exibido', 'popup:alcance', 'popup:sim', 'popup:nao', 'popup:motivos'];
